...
class EnvironmentIdOnConfigImportTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = $this->createPartialMockWithReflection(Value::class, ['getPath', 'getValue']);
     ...
     */
    private function setUpExpectedResponse(?string $environmentId): MockObject
    {
        $value = $this->createPartialMockWithReflection(Value::class, ['getPath', 'getValue']);
