...
class ConfigProvider implements ConfigProviderInterface
{
    ...
    public function __construct(
        ...
        protected readonly CspNonceProvider $cspNonceProvider,
        ...
        return [
            'payment' => [
                ...
                self::PAYPAL_CREDIT_CODE => [
                    ...
                    'isActiveShipping' => $this->isActiveShipping('credit'),
                ...
                self::PAYPAL_PAYLATER_CODE => [
                    ...
                    'isActiveShipping' => $this->isActiveShipping('paylater'),
    ...
    /**
     * Is PayPal enabled for top of checkout
     *
     * @param string $type
     * @return bool
     */
    public function isActiveShipping(string $type = 'paypal'): bool
    {
        return (bool) $this->config->isActive() && $this->config->showPayPalButton($type, Config::BUTTON_AREA_CHECKOUT);
    }
}
