...
class Config extends \Magento\Payment\Gateway\Config\Config
{
    ...
    public const SANDBOX_GATEWAY_URL = 'sandbox_gateway_url';
    public const PRODUCTION_GATEWAY_URL = 'gateway_url';
    public const PATH_MULTI_COUPON = 'sales/multicoupon/maximum_number_of_coupons_per_order';
     ...
     * @var array
     */
    private static array $dynamicDescriptorKeys = [
        'name', 'phone', 'url'
    ];
    ...
    /**
     * Get braintree sandbox gateway url
     *
     * @return string
     * @throws InputException
     * @throws NoSuchEntityException
     */
    public function getSandboxGatewayUrl(): string
    {
        return $this->getValue(
    ...
    /**
     * Get braintree production gateway url
     *
     * @return string
     * @throws InputException
     * @throws NoSuchEntityException
     */
    public function getProductionGatewayUrl(): string
    {
        return $this->getValue(
