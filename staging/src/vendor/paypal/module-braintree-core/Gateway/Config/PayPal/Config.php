...
class Config extends \Magento\Payment\Gateway\Config\Config
{
    ...
    public const KEY_CONTACT_PREFERENCE = 'contact_preference';
    ...
    public function __construct(
        ...
        private readonly Color $colorConfigSource,
        private readonly Shape $shapeConfigSource,
        private readonly CreditColor $creditColorSource,
    ...
    public function getPayPalIcon(): array
    {
        if (empty($this->icon)) {
            ...
            $imageData = $this->fileIo->read($asset->getSourceUrl());
     ...
     */
    public function getContactPreference(?int $storeId = null): bool
    {
        return (bool) $this->getValue(
            self::KEY_CONTACT_PREFERENCE,
            $storeId ?? $this->storeConfigResolver->getStoreId()
        );
    }
}
