    ...
    function (
        ...
        return {
            init: function (element, context) {
                ...
                if (context.onPaymentDataChanged) {
                ...
                let paymentsClient = new window.google.payments.api.PaymentsClient({
                    ...
                    color = parseInt(context.getBtnColor(), 10) === 1 ? 'black' : 'white';
                        ...
                        button.addEventListener('click', async function (event) {
                            ...
                            if (!shouldDisableActions) {
                                ...
                                if (typeof context.onButtonClick === 'function') {
                                    context.onButtonClick(paymentsClient, googlePaymentInstance);
                                } else {
                                    const paymentData = await context.getPaymentRequest();
