    ...
    function (
        ...
        return {
            ...
            render: function (applePayErr, applePayInstance, dataCollectorInstance, element, context) {
                ...
                let el = document.createElement('apple-pay-button');
                ...
                el.addEventListener('click', function (e) {
                    ...
                    try {
                        ...
                        // Attach onCouponCodeChanged method
                        if (typeof context.onCouponCodeChanged === 'function') {
                            session.oncouponcodechanged = function (event) {
                                return context.onCouponCodeChanged(event, session);
                            };
                        }
                ...
                element.classList.remove('braintree-hidden');
